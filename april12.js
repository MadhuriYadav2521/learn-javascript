...
var studentList = [ 'kunal', 'anu', 'poonam','krishnan','snehal','swaraj']
...
if(flagforSwaraj == false){
    console.log('swaraj is not in our db.');
}
for(var i=0; i<studentList.length;i++){
    if(studentList[i]=='swaraj' || studentList[i]=='kunal'){
        console.log('swaraj and kunal is in our data');
    }
}
